...
const RightSidebar = () => {
    return (
        <>
            <div className="hidden md:flex z-5 0 overflow-y-scroll no-scrollbar flxed right-0 top-0 bg-black h-screen flex-col pr-16 p-1 px-6 border-l border-zinc-700/90">
