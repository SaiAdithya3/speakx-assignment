        ...
        <div className="bg-black w-full flex items-center flex-col">
            <div className="w-full sticky top-0 flex items-center justify-center">
                <div className="w-full pt-4 border-b border-zinc-500/50 flex bg-black/60 backdrop-blur-md text-white z-10">
                    <div
                        className={`w-1/2 flex flex-col gap-2 justify-start items-center cursor-pointer ${activeSection === 'forYou' ? 'text-[#1d9bf0]' : ''
                            }`}
                    ...
                    <div
                        className={`w-1/2 flex flex-col gap-2 justify-start items-center cursor-pointer ${activeSection === 'following' ? 'text-[#1d9bf0]' : ''
                            }`}
